...
LastEditTime: 2023-07-04 21:50:36
...
class AUTDThread(QThread):
    ...
    def run(self):
        ...
        geometry = Geometry.Builder()\
            .add_device([W_cos - (DEVICE_WIDTH - W_cos), DEVICE_HEIGHT - 20, 0.], [math.pi, math.pi/12, 0.])\
            .add_device([W_cos - (DEVICE_WIDTH - W_cos), -20., 0.], [math.pi, math.pi/12, 0.])\
